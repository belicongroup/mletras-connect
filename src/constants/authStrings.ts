...
const en: AuthStrings = {
  ...
  countryOther: 'Other',
  usernamePermanentNote: 'Your username is permanent and cannot be changed later. Usernames are not case-sensitive.',
...
const es: AuthStrings = {
  ...
  countryOther: 'Otro',
  usernamePermanentNote: 'Tu usuario es permanente y no se puede cambiar después. No distingue mayúsculas y minúsculas.',
